      ...
      <div className="p-4">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {actions.map((action) => (
            <div 
              key={action.id}
              className="border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center cursor-pointer transition-all hover:shadow-md hover:border-primary"
