...
export const patients = pgTable("patients", {
  ...
  portalUsername: varchar("portal_username", { length: 100 }).unique(),
  portalPassword: text("portal_password"),
  portalLastLogin: timestamp("portal_last_login"),
  portalActivationToken: text("portal_activation_token"),
  portalActivationExpires: timestamp("portal_activation_expires"),
  portalPasswordResetToken: text("portal_password_reset_token"),
  portalPasswordResetExpires: timestamp("portal_password_reset_expires"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
